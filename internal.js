  ...
  function ensurePwaPanel(force = false) {
    ...
    host.innerHTML = `
      <style>
        ...
        #pnj-pwa-panel input[type=number]::-webkit-inner-spin-button, 
        #pnj-pwa-panel input[type=number]::-webkit-outer-spin-button { 
          -webkit-appearance: none; 
          margin: 0; 
        }
        #pnj-pwa-panel input[type=number] {
        ...
        #pnj-pwa-panel button {
          ...
          color: #fff;
          cursor: pointer;
          font: 950 14px/1 "Arial Rounded MT Bold", system-ui, sans-serif;
          text-transform: uppercase;
          text-shadow: 0 2px 0 rgba(30,8,92,.55);
        }
        #pnj-pwa-panel button:hover { filter: brightness(1.08); }
